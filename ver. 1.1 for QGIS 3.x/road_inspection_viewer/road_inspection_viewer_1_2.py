...
class road_inspection_viewer(QtWidgets.QMainWindow):
    ...
    def initGui(self):
        ...
        uic.loadUi(os.path.join(self.base_path, 'road_inspection_viewer.ui'), self)
    ...
    def unload(self):
        ...
        self.Play_back_pushButton.disconnect.connect(self.Play_back_handleButton)
        ...
        self.Play_forward_pushButton.disconnect.connect(self.Play_forward_handleButton)
        ...
        self.Extra_window_pushButton.disconnect.connect(self.Extra_window_handleButton)
...
class extra_window(QtWidgets.QMainWindow):
    ...
    def  __init__(self, no, image, parent):
        ...
        self.parent = parent
        self.raw_image = image
        uic.loadUi(os.path.join(self.parent.base_path, 'extra_window.ui'), self)
