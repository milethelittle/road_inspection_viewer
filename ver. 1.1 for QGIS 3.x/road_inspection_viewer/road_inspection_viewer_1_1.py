...
class road_inspection_viewer(QtWidgets.QMainWindow):
    ...
    def  __init__(self, iface):
        ...
        self.Path_pushButton = QtWidgets.QPushButton(self)
        ...
        self.Play_back_pushButton = QtWidgets.QPushButton(self)
        ...
        self.Back_pushButton = QtWidgets.QPushButton(self)
        ...
        self.Forward_pushButton = QtWidgets.QPushButton(self)
        ...
        self.Play_forward_pushButton = QtWidgets.QPushButton(self)
        ...
        self.Delay_pushButton = QtWidgets.QPushButton(self)
        ...
        self.About_pushButton = QtWidgets.QPushButton(self)
    ...
    def initGui(self):
        self.action = QtWidgets.QAction(self.icon, SCRIPT_TITLE + ' plugin', self.iface.mainWindow())
    ...
    def Path_handleButton(self):
        text, ok = QtWidgets.QInputDialog.getText(self, SCRIPT_TITLE, 'Enter a path to photos folder:')
    ...
    def Save_handleButton(self):
        if self.raw_image:
            path_to_file = QtWidgets.QFileDialog.getSaveFileName(self, 'Save photo', self.save_path, '*.jpg')
            if path_to_file:
...
class extra_window(QtWidgets.QMainWindow):
    ...
    def  __init__(self, no, image, parent):
        ...
        self.Save_pushButton.setObjectName('Save_pushButton')
        self.Save_pushButton.setText('save')
        self.Set_parent_size_pushButton = QtWidgets.QPushButton(self)
    ...
    def Save_handleButton(self):
        if self.raw_image:
            path_to_file = QtWidgets.QFileDialog.getSaveFileName(self, 'Save photo', self.parent.save_path, '*.jpg')
            if path_to_file:
                self.raw_image.save(path_to_file, 'JPG')
